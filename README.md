...
* Rational ratios up to a numerator of 31, There is a combination of first upsample and bandlimit with a single filter kernel and then a trivial decimation step (the divisor)
* For more uneven ratios (such as 147/320, needed for 96k -> 44k1) the is first an upsample and bandlimit-step to get to 32x and then an interpolating sampler is used based on "Polynomial Interpolators for
...
Quality measurements by "Hydrogen Audio" here: https://src.hydrogenaudio.org/compareresults?id1=7ad149e6-7495-493b-a9c0-f9b17d8d8a34
